function perform_heterodyne_measurement(app, dlg)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
x_vec_detec = (1:app.cameraSize(1));
xy_mat_detec = ones(app.cameraSize(2),1) * x_vec_detec;
...
for ii=0:N-1
    ...
    filename = ['1_' num2str(ii) '.bmp'];
    imwrite(app.recentFrame, filename);
end
dlg.Value = 1/3;
% 2. Lambda 2
...
z_data_orem = reshape(z_data_vec_orem, flip(app.cameraSize));
...
gu = 1:app.cameraSize(1);
gv = 1:app.cameraSize(2);
gv = flip(gv);
[X,Y] = meshgrid(gu,gv);
